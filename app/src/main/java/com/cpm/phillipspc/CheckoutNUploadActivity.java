...
import com.cpm.phillipspc.getterSetter.CustomerInfoGetterSetter;
...
public class CheckoutNUploadActivity extends AppCompatActivity {
    ...
    private class UploadTask extends AsyncTask<Void,Data,String> {
        ...
        public UploadTask( CheckoutNUploadActivity checkoutNUploadActivity) {
            this.context = checkoutNUploadActivity;
        }
        ...
        protected void onPreExecute() {
            ...
            dialog.setTitle("Uploading Previous Day Data");
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                data = new Data();
                coverageBeanlist = database.getCoveragePreviousData(date, user_name);
                ...
                for (int i = 0; i < coverageBeanlist.size(); i++) {
                    ...
                    if (coverageBeanlist.get(i).getStatus().equalsIgnoreCase(CommonString.KEY_C)) {
                        onXML = "";
                        onXML =
                                "[DATA][USER_DATA]"
...
*/
                        ...
                        visitorLoginData = database.getPreviousDayVisitorLoginData(date);
                        ...
                        database.open();
                        database.deleteSpecificTablesAfterUpload();
                    }
                }
        ...
        protected void onPostExecute(String result) {
            ...
            if (isError) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CheckoutNUploadActivity.this);
    ...
    private void message(String str) {
        ...
        builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(CheckoutNUploadActivity.this, MainMenuActivity.class));
                finish();
                dialog.dismiss();
            }
        });
