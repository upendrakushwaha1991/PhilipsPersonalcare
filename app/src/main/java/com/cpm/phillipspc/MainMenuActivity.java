...
import com.cpm.phillipspc.dailyEntry.ClientFeedbackActivity;
import com.cpm.phillipspc.dailyEntry.StoreListActivity;
import com.cpm.phillipspc.dailyEntry.StoreListForCampaignActivity;
import com.cpm.phillipspc.dailyEntry.VisitorLoginActivity;
import com.cpm.phillipspc.database.PhilipsAttendanceDB;
import com.cpm.phillipspc.download.DownloadActivity;
...
public class MainMenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cpm.phillipspc.R.layout.activity_main_menu);
        declaration();
    ...
    public void onBackPressed() {
        DrawerLayout drawer =  findViewById(com.cpm.phillipspc.R.id.drawer_layout);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.cpm.phillipspc.R.id.action_settings) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
        if (id == com.cpm.phillipspc.R.id.dailyEntry) {
        ...
        } else if (id == com.cpm.phillipspc.R.id.downloadData) {
        ...
        }else if (id == com.cpm.phillipspc.R.id.visitorLogin) {
        ...
        else if (id == com.cpm.phillipspc.R.id.exit) {
        ...
        else if (id == com.cpm.phillipspc.R.id.nav_export_database) {
            ...
            builder1.setMessage("Are you sure you want to take the backup of your data")
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            try {
                                File file = new File(Environment.getExternalStorageDirectory(), "philipsPersonalCare_backup");
                                if (!file.isDirectory()) {
                                    file.mkdir();
                                }
                                ...
                                if (sd.canWrite()) {
                                    ...
                                    String currentDBPath = "//data//com.cpm.phillipspc//databases//" + PhilipsAttendanceDB.DATABASE_NAME;
                                    //String backupDBPath = "PngAttendance_backup" + dateString.replace('/', '-');
                                    String backupDBPath = "PhilipsPersonalCare_" + user_name.replace(".", "") + "_backup-" + visit_date_formatted + "-" + CommonFunctions.getCurrentTimeHHMMSS().replace(":", "") + ".db";

                                    String path = Environment.getExternalStorageDirectory().getPath() + "/philipsPersonalCare_backup";
    ...
    void declaration() {
        ...
        Toolbar toolbar =  findViewById(com.cpm.phillipspc.R.id.toolbar);
      ...
      //  clientFeedbackIntent = new Intent(context, ClientFeedbackActivity.class);
        imageView =  findViewById(com.cpm.phillipspc.R.id.img_main);
        webView =  findViewById(com.cpm.phillipspc.R.id.webview);


        DrawerLayout drawer = (DrawerLayout) findViewById(com.cpm.phillipspc.R.id.drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, com.cpm.phillipspc.R.string.navigation_drawer_open, com.cpm.phillipspc.R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();
        NavigationView navigationView = (NavigationView) findViewById(com.cpm.phillipspc.R.id.nav_view);
