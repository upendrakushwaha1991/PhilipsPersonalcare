package com.cpm.phillipspc.database;
...
import com.cpm.phillipspc.getterSetter.AnswersGetterSetter;
...
import com.cpm.phillipspc.getterSetter.QuestionnaireGetterSetter;
import com.cpm.phillipspc.getterSetter.QuestionsGetterSetter;
...
import com.cpm.phillipspc.getterSetter.VisitorLoginGetterSetter;
...
public class PhilipsAttendanceDB extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "PhilipsPersonalCare_DB";
