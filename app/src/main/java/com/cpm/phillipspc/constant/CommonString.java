...
public class CommonString {
    ...
    public static final String IMAGES_FOLDER_NAME = ".PhilipsPersonal_Care_Images";
    ...
    public static String URL = "http://pipc.parinaam.in/PhilipspercarewebService.asmx";
    public static String URL2 = "http://pipc.parinaam.in/PhilipspercarewebService.asmx/";
