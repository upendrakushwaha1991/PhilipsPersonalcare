...
public class AttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cpm.phillips.R.layout.activity_attendance);
        declaration();
        prepareList();


        FloatingActionButton fab = (FloatingActionButton) findViewById(com.cpm.phillips.R.id.fab);
    ...
    void declaration() {
        context = this;
        Toolbar toolbar = (Toolbar) findViewById(com.cpm.phillips.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        spinner = (Spinner) findViewById(com.cpm.phillips.R.id.attendance_spn);
